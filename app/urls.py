...
urlpatterns = [
    ...
    path('api/spa/sale/step1/', register.spa_sale_step1),
    path('api/spa/sale/step2/', register.spa_sale_step2),
    path('api/spa/sale/step3/', register.spa_sale_step3),
    ...
    path('register/cancel/bill', register.cancel_bill, name="CancelBill"),
...
#     path('finance/teacher', finance.withdraw_list), 
    ...
    path('pay/payment/create/', finance.payment_pay_deposit, name="PaymentDeposit"),
    ...
    path('commissionstages/setting/form', desbill.setting_form_commissionstages,
         name="com_setting_form_seclect"),
