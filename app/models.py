...
class learn(models.Model):
    ...
    register = models.ForeignKey(register_main, on_delete=models.CASCADE)
    reg_prefix_thai = models.CharField(blank=True, null=True, max_length=255)
    reg_name_thai = models.CharField(blank=True, null=True, max_length=255)
    reg_lname_thai = models.CharField(blank=True, null=True, max_length=255)
    reg_prefix_eng = models.CharField(blank=True, null=True, max_length=255)
    reg_name_eng = models.CharField(blank=True, null=True, max_length=255)
    reg_lname_eng = models.CharField(blank=True, null=True, max_length=255)
    tax_id = models.CharField(blank=True, null=True, max_length=255)
    birthday = models.CharField(blank=True, null=True, max_length=255)
    age = models.CharField(blank=True, null=True, max_length=255)
    religion = models.CharField(blank=True, null=True, max_length=255)
    passport_number = models.CharField(blank=True, null=True, max_length=255)
    expire_passport = models.CharField(blank=True, null=True, max_length=255)
    address_present = models.CharField(blank=True, null=True, max_length=255)
    road_present = models.CharField(blank=True, null=True, max_length=255)
    village_present = models.CharField(blank=True, null=True, max_length=255)
    subdistrict_present = models.CharField(blank=True, null=True, max_length=255)
    district_present = models.CharField(blank=True, null=True, max_length=255)
    province_present = models.CharField(blank=True, null=True, max_length=255)
    zipcode_present = models.CharField(blank=True, null=True, max_length=255)
    address_card = models.CharField(blank=True, null=True, max_length=255)
    road_card = models.CharField(blank=True, null=True, max_length=255)
    village_card = models.CharField(blank=True, null=True, max_length=255)
    subdistrict_card = models.CharField(blank=True, null=True, max_length=255)
    district_card = models.CharField(blank=True, null=True, max_length=255)
    province_card = models.CharField(blank=True, null=True, max_length=255)
    zipcode_card = models.CharField(blank=True, null=True, max_length=255)
    tel_contact = models.CharField(blank=True, null=True, max_length=255)
    mobile_contact = models.CharField(blank=True, null=True, max_length=255)
    email_contact = models.CharField(blank=True, null=True, max_length=255)
    reg_name_person = models.CharField(blank=True, null=True, max_length=255)
    relationship_person = models.CharField(blank=True, null=True, max_length=255)
    tel_person = models.CharField(blank=True, null=True, max_length=255)
    status = models.CharField(blank=True, null=True, max_length=1)
